# The Culling Game: Testing A Decentralized Approach to Disrupting Inequality

### Introduction. Idea Behind the Culling Game
...
There's a need for a new approach, and that's where the Culling Game offers intriguing possibilities to
test a new system that tuckles inequality in a novel way.
...
winner taking the staked tokens. These tokens can be used to acquire new cards or—critically—to propose rule 
